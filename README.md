...
| MongoDB       | 43570      | 3074.4      | 16         | 6206.1   |
| Redis         | -          | 25569.7     | 1          | 213      |
...
| Регион           | Количество ДЦ | Kubenode | MongoDB | Tarantool | Redis | ElasticSearch | S3 |
|------------------|---------------|----------|---------|-----------|-------|---------------|----|
| Азия             | 2             | 2        | 2       | 2         | 2     | 2             | 2  |
| Европа           | 1             | 1        | 1       | 1         | 1     | 1             | 1  |
| Северная Америка | 1             | 1        | 1       | 1         | 1     | 1             | 1  |

### Конфигурации серверов
| Название      | Конфигурация             | CPU (ядра) | Количество | Покупка | Аренда (1 год) |
|---------------|--------------------------|------------|------------|---------|----------------|
| Kubenode      | 1x7313/1x16/1xNVMe950GB  | 16         | 12         | 8500$   | 7065$          |
| MongoDB       |
| Tarantool     |
| Redis         |
| ElasticSearch |
