...
| Сервис                  | Пиковый RPS | Сложность | CPU (ядра) | RAM (Гб) |
|-------------------------|-------------|-----------|------------|----------|
| Пополнение кошелька     | 3           | Тяжелая   | 1          | 1        |
| Поиск                   | 799         | Легкая    | 1          | 1        |
| Авторизация             | 36          | Легкая    | 1          | 1        |
| Пользователи            | 389.4       | Средняя   | 6          | 1        |
| Разработчики            | 1           | Легкая    | 1          | 1        |
| Магазин игр             | 2067        | Средняя   | 31         | 4        |
| Библиотека пользователя | 12669       | Легкая    | 4          | 1        |
| Игры                    | 1           | Легкая    | 1          | 1        |
| Отзывы к играм          | 2061.2      | Средняя   | 31         | 4        |
| Игровые предметы        | 1           | Легкая    | 1          | 1        |
| Курс валют              | 1           | Легкая    | 1          | 1        |
| Торговая площадка       | 9.65        | Тяжелая   | 2          | 1        |
| Инвентарь пользователя  | 216         | Легкая    | 1          | 1        |
| Торговый обмен          | 34.74       | Тяжелая   | 6          | 1        |
| Всего                   | 18288.99    | -         | 88         | 20       |
...
|---------------|-------------|-------------|------------|----------|
| Tarantool     | 18          | 8280        | 6          | 6        |
| Cassandra     | 2721        | 25324.2     | 24         | 96       |
| MongoDB       | 130710      | 3074.4      | 768        | 6206     |
...
#### Европа, США
| Название      | Конфигурация               | CPU (ядра) | RAM (Гб) | Количество | Покупка одного (+20%) | Аренда одного              |
|---------------|----------------------------|------------|----------|------------|-----------------------|----------------------------|
| Kubenode      | 2x4314/2x16GB/2xNVMe600GB  | 32         | 32       | 12         | 8634$                 | 12780$ / год               |
| Cassandra     | 1x4208/1x8GB/2xNVMe1875GB  | 8          | 32       | 6          | 3142$                 | 7901$  / год               |
| MongoDB       | 2x4208/2x32GB/1xNVMe950GB  | 16         | 64       | 194        | 3833$                 | 8410$  / год               |
| Tarantool     | 1x3106/1x16GB/1xNVMe300GB  | 8          | 16       | 6          | 1601$                 | 4100$  / год               |
| Redis         | 2x4208/2x32GB/1xNVMe950GB  | 16         | 64       | 10         | 3833$                 | 8410$  / год               |
| ElasticSearch | 1x3204/1x32GB/2xNVMe300GB  | 12         | 32       | 6          | 1980$                 | 8200$  / год               |
| S3            | 24xHDD20TB                 | 6          | 96       | 21         | 96520$                | 56070$ / мес               |

#### Азия
| Название      | Конфигурация               | CPU (ядра) | RAM (Гб) | Количество | Покупка одного (+20%) | Аренда одного (1 год)      |
|---------------|----------------------------|------------|----------|------------|-----------------------|----------------------------|
| Kubenode      | 2x4314/2x16GB/2xNVMe600GB  | 32         | 32       | 6          | 8634$                 | 12780$ / год               |
| Cassandra     | 1x4208/1x8GB/2xNVMe1875GB  | 8          | 32       | 6          | 3142$                 | 7901$  / год               |
| MongoDB       | 2x4208/2x32GB/1xNVMe950GB  | 16         | 64       | 194        | 3833$                 | 8410$  / год               |
| Tarantool     | 1x3106/1x16GB/1xNVMe300GB  | 8          | 16       | 6          | 1601$                 | 4100$  / год               |
| Redis         | 2x4208/2x32GB/1xNVMe950GB  | 16         | 64       | 10         | 3833$                 | 8410$  / год               |
...
| Регион           | Количество ДЦ | Kubenode | Cassandra | MongoDB  | Tarantool | Redis | ElasticSearch | S3 |
|------------------|---------------|----------|-----------|----------|-----------|-------|---------------|----|
| Азия             | 2             | 6        | 6         | 194      | 6         | 10    | 6             | 21 |
| Европа           | 1             | 6        | 3         | 97       | 3         | 5     | 3             | 21 |
| Северная Америка | 1             | 6        | 3         | 97       | 3         | 5     | 3             | 21 |
