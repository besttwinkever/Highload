...
## 11. Список серверов
На 1 CPU выделим следующие сложности логики сервисов:
- Тяжелая: 
- Средняя: 
- Легкая: 

Тогда на каждый сервис получим:
| Сервис                  | Пиковый RPS | Сложность | CPU (ядра) | RAM (Гб) | Пиковый трафик Гбит/сек |
|-------------------------|-------------|-----------|------------|----------|-------------------------|
| Пополнение кошелька     |
| Поиск                   |
| Авторизация             |
