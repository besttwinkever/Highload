...
- Пиковый RPS возьмем в 2 раза выше среднего (согласно [^11]). В нашем сервисе пользователи расположены в разных часовых поясах, потому пиковая нагрузка будет не настолько резко большой.
...
- store.steam.com - для взаимодействия с играми (покупка, скачивание игр)
- community.steam.com - для взаимодействия с системами комьюнити (обмен/продажа предметов, профили, ...)
...
- Азия: Шанхай, Пекин (Китай), Токио (Япония), Сеул (Южная Корея), Сингапур
- Европа: Франкфурт (Германия), Лондон (Великобритания), Варшава (Польща), Марсель (Франция)
- Северная Америка: Ашберн (Северная Вирджиния), Даллас (Техас), Сан Хосе (Калифорния)
- Россия: Москва
...
<img width="1042" height="694" alt="image" src="https://github.com/user-attachments/assets/a6dd0446-a970-499f-9ac3-cd6aff8f8aff" />  

### Расчет распределения запросов
Сперва обозначим процент трафика из регионов. Из [^11] известно, что:
| Регион           | Использовано трафика (Tbps) |
|------------------|-----------------------------|
| Азия             | 13.6                        |
| Европа           | 5.5                         |
...
Суммарный трафик: 25.224 Tbps  
Тогда переводя в процентное соотношение по формуле: (трафик региона / общий трафик) * 100%:
| Регион           | Процентная доля трафика     |
|------------------|-----------------------------|
| Азия             | 53.9                        |
| Европа           | 21.8                        |
| Северная Америка | 8.72                        |
| Россия           | 7.53                        |
| Ближний Восток   | 3.17                        |
| Океания          | 3.08                        |
| Южная Америка    | 1.77                        |

Будем считать по формуле: (RPS на действие) * (% трафика региона)  
| Действие                                             | Азия   | Европа | Северная Америка | Россия | Ближний Восток | Океания | Южная Америка |
|------------------------------------------------------|--------|--------|------------------|--------|----------------|---------|---------------|
| Аутентификация                                       | 13     | 5.23   | 2.09             | 1.8    | 0.76           | 0.74    | 0.42          |
| Просмотр игры 	                                     | 740.59 | 300    | 119.8            | 103.46 | 43.55          | 42.32   | 24.32         |
| Покупка игры                                         | 2.16   | 0.87   | 0.35             | 0.3    | 0.13           | 0.12    | 0.07          |
| Скачивание игры                                      | 676    | 273.37 | 109.35           | 94.43  | 39.75          | 38.62   | 22.19         |
| Совершение торгового обмена                          | 12.48  | 5.05   | 2.02             | 1.74   | 0.73           | 0.71    | 0.41          |
| Выставление предмета на продажу на торговой площадке | 0.3    | 0.12   | 0.05             | 0.041  | 0.017          | 0.016   | 0.01          |
| Просмотр предмета на торговой площадке               | 3      | 1.22   | 0.49             | 0.42   | 0.18           | 0.17    | 0.1           |
| Покупка предмета на торговой площадке                | 0.15   | 0.06   | 0.024            | 0.021  | 0.009          | 0.008   | 0.005         |
| Просмотр профиля                                     | 127    | 51.36  | 20.54            | 17.74  | 7.47           | 7.26    | 4.17          |
| Обновление профиля                                   | 13     | 5.23   | 2.09             | 1.8    | 0.76           | 0.74    | 0.42          |
| Просмотр предметов                                   | 77.6   | 31.4   | 12.56            | 10.84  | 4.56           | 4.43    | 2.55          |
| Отзыв об игре                                        | 0.07   | 0.03   | 0.012            | 0.010  | 0.004          | 0.004   | 0.0024        |
