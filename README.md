...
todo: переделать картинку под новое описание. Нормализация/денормализация  
...
| UserSession     | Данные о сессиях пользователя: id сессии, id пользователя, токен, срок действия, дата создания (created_at), дата изменения (updated_at)                                                                                                                                  |
...
| GameAchievement | Данные о достижениях игры: id, id игры, название, описание, дата создания (created_at), дата изменения (updated_at)                                                                                                                                                       |
...
### Размеры данных
| Таблица | Размер строки | Всего строк | Размер таблицы |
|---------|---------------|-------------|----------------|
| todo    |               |             |                |
