...
#### Elasticsearch
Для реализации функции поиска воспользуемся поисковым движком Elasticsearch
...
#### Шардирование
Пиковой нагрузки на запись в таблицах с большим объемом данных нет. Шардирование не требуется, достаточно резервировать.
