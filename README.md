...
Отдельно выделим компоненты
| Компонент   | Пиковый RPS | CPU (ядра) | RAM (Гб) |
|-------------|-------------|------------|----------|
| Nginx       | 30831       | 62         | 1        |
| API Gateway | 30831       | 62         | 1        |
...
|---------------|------------|-------------|------------|----------|
| Tarantool     | 1          | 8280        | 1          | 1        |
| Cassandra     | 907        | 25324.2     | 38         | 32       |
| MongoDB       | 43570      | 3074.4      | 16         | 158      |
| Redis         | -          | 25569.7     | 1          | 213      |
...
Размещаем основные сервера и S3 в 3 ключевых регионах: Америка, Европа, Азия + отдельно Китай.  
Используем Kubernetes

### Конфигурации серверов
| Название      | Конфигурация | CPU (ядра) | Количество | Покупка | Аренда (1 мес) |
|---------------|--------------|------------|------------|---------|----------------|
| Kubenode      | 
| Nginx         |
| API Gateway   |
