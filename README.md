...
|---------------|----------------------------------------------------------------------------------------------|
| Nginx         | Если активный инстанс nginx выйдет из строя, резервный включится в работу                    |
| MongoDB       | Репликация                                                                                   |
| Cassandra     | Репликация                                                                                   |
| Tarantool     | Репликация                                                                                   |
| ElasticSearch | Репликация                                                                                   |
| Redis         | Репликация                                                                                   |
| Kubernetes    | Отказоустойчивость микросервисов, healthcheck, автоматическое горизонтальное масштабирование |
| Kafka         | Репликация топиков                                                                           |
| Prometheus    | Бэкап данных                                                                                 |

## 10. Схема проекта
<img width="1402" height="2651" alt="Steam drawio" src="https://github.com/user-attachments/assets/8e3d527c-c2a9-4a3e-91a2-55b743d91e6d" />
