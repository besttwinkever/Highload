...
### Резервирование
Реплицируем БД, топики Kafka, резервируем Nginx
...
Пусть на 1 ядро CPU будет выделено 1000 запросов. Также будем учитывать индексы Mongo и Tarantool в RAM.

Тогда получим:
| Хранилище     | Диск (Гб)  | Пиковый QPS | CPU (ядра) | RAM (Гб) |
|---------------|------------|-------------|------------|----------|
| Tarantool     | 1          | 8280        | 13         | 1        |
| Cassandra     | 907        | 25324.2     | 38         | 32       |
| MongoDB       | 43570      | 3074.4      | 5          | 158      |
| Redis         | -          | 25569.7     | 39         | 213      |
| ElasticSearch | 60         | 1597        | 3          | 32       |

Однако у нас есть реплицирование (1 master + 2 реплики). Тогда, умножив на 3, получим
| Хранилище     | Диск (Гб)  | Пиковый QPS | CPU (ядра) | RAM (Гб) |
|---------------|------------|-------------|------------|----------|
| Tarantool     | 3          | 8280        | 39         | 3        |
| Cassandra     | 2721       | 25324.2     | 114        | 96       |
| MongoDB       | 130710     | 3074.4      | 15         | 473      |
| Redis         | -          | 25569.7     | 117        | 637      |
| ElasticSearch | 180        | 1597        | 24         | 96       |
