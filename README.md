...
<img width="862" height="500" alt="image" src="https://github.com/user-attachments/assets/16e69da5-cb78-4f3a-989c-68d11cbd4262" />
...
### L4 балансировка
Для повышения отказоустойчивости будем использовать минимум 2 балансировщика (1 основной и 1 резервный) на основе LVS (Linux Virtual Server) и технологии keepalived с VRRP.

### L7 балансировка
Будем использовать Nginx (минимум 2 сервера, оба активны). В качестве балансировки используется алгоритм Weighted Round-Robin, чтобы равномерно распределить нагрузку. Будем кэшировать статический контент. Дополнительно можно сжимать трафик (gzip)
