...
| Просмотр предмета на торговой площадке               |  |
| Покупка предмета на торговой площадке                |  |
...
- За период 1 января 2024 - 1 января 2025 [^8] выставлялось 18.9М предметов => за день: 18.9M / 365 = 51780 => один пользователь в среднем выставляет на продажу: 0.0007
...
| Действие                        | Трафик на действие | Средняя нагрузка (Гбит/с) | Пиковая нагрузка (Гбит/с) |
|---------------------------------|--------------------|---------------------------|---------------------------|
| Аутентификация                  | 888 байт           | 0.00017                   | 0.00034                   |
| Просмотр игры                   | 2.66 KB            | 0.03                      | 0.06                      |
| Покупка игры                    | 286 байт           | 0.000009                  | 0.000018                  |
| Совершение торгового обмена     | 2.61 KB            | 0.0005                    | 0.001                     |
| Выставление предмета на продажу | 2.15 KB            | 0.0000986                 | 0.0001972                 |
| Просмотр профиля                | 2.11 KB            | 0.004                     | 0.008                     |
| Обновление профиля              | 4.36 KB            | 0.00086                   | 0.00172                   |
| Просмотр предметов              | 2.11 KB            | 0.0025                    | 0.005                     |
...
[^11]: [](https://store.steampowered.com/stats/content/)
